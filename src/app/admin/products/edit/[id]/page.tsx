  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (validated.discountPrice)
        form.append("discountPrice", String(validated.discountPrice));
      if (validated.discountBadge)
        form.append("discountBadge", validated.discountBadge);
    ...
    >
      ...
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6">
        <div className="flex items-center gap-4">
          <Link
            href="/admin/products"
            className="w-9 h-9 flex items-center justify-center border-none text-text-muted hover:text-[#222222] hover:bg-dasadeep/50 transition-colors bg-white"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 space-y-8">
          {/* GENERAL INFORMATION */}
          <div className="bg-white border-none p-6 md:p-8">
            <h3 className="text-[14px] uppercase tracking-widest font-bold text-[#222222] mb-6 pb-4">
              General Information
            </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <Input
                  ...
                  className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-[#222222] h-12"
                />
                {errors.name && (
                  <p className="text-red-600 text-[10px] uppercase tracking-wider font-bold mt-1.5">
                    {errors.name}
                  </p>
                )}
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-[#222222] h-12"
                />
                <p className="text-[10px] text-text-muted mt-2 tracking-wider font-medium">
              ...
              <div>
                ...
                >
                  <SelectTrigger className="w-full bg-dasadeep/20 text-[13px] text-[#222222] h-12 rounded-2xl focus:ring-0 focus:">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-primary font-bold h-12"
                  />
                  <p className="text-[10px] text-text-muted mt-2 tracking-wider font-medium">
                    The selling price.
                  </p>
                ...
                <div>
                  ...
                  <Input
                    ...
                    className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-text-muted h-12"
              ...
              <div className="md:col-span-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setProduct({ ...product, discountBadge: e.target.value })
                  }
                  className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-[#222222] h-12"
                  placeholder="e.g. SALE or -20%"
                />
                <p className="text-[10px] text-text-muted mt-2 tracking-wider font-medium">
                  Appears as a badge on the top left of the product image.
                </p>
                {errors.discountBadge && (
                  <p className="text-red-600 text-[10px] uppercase tracking-wider font-bold mt-1.5">
                    {errors.discountBadge}
                  </p>
                )}
            ...
            <div className="space-y-8">
              <div>
                ...
                <Textarea
                  ...
                  className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-[#222222] min-h-[140px] resize-y p-4"
                />
                <p className="text-[10px] text-text-muted mt-2 tracking-wider font-medium">
                  This text is displayed right below the price and rating.
                </p>
                {errors.description && (
                  <p className="text-red-600 text-[10px] uppercase tracking-wider font-bold mt-1.5">
                    {errors.description}
              ...
              <div className="pt-6 ">
                ...
                <p className="text-[10px] text-text-muted mb-4 tracking-wider font-medium">
                  These appear as bullet points in the "Key Features" accordion.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-5">
                  <Input
                    ...
                    className="bg-dasadeep/20 text-[13px] rounded-2xl focus-visible:ring-0 focus-visible: text-[#222222] h-12 flex-1"
                  />
                  <button
                    type="button"
                    onClick={handleAddFeature}
                    className="bg-dasadeep/50 text-[#222222] border-none px-8 text-[11px] uppercase tracking-wider font-bold hover:bg-dasadeep transition-colors h-12 shrink-0"
                  >
                    Add Feature
                  </button>
                </div>
                ...
                {product.features.length > 0 ? (
                  <ul className="space-y-2 bg-dasadeep/10 p-4 border-none ">
                  ...
                  <div className="bg-dasadeep/10 p-4 border-none text-[12px] text-text-muted italic">
          ...
          <div className="bg-white border-none p-6 md:p-8">
            ...
            <p className="text-[10px] text-text-muted mb-4 tracking-wider font-medium">
              These images appear in the sticky slider on the left side of the
              product page.
            </p>
            ...
            {mergedImages.length < MAX_IMAGES ? (
              <div
                {...getRootProps()}
                className={`p-12 border-none rounded-2xl text-center cursor-pointer transition-colors ${
                  isDragActive ? " bg-primary/5" : " hover: bg-dasadeep/10"
                }`}
              >
                <input {...getInputProps()} />
                <UploadCloud
                  className="w-10 h-10 text-text-muted mx-auto mb-4"
                  strokeWidth={1.5}
                />
                <p className="text-[13px] text-[#222222] font-bold uppercase tracking-wider">
                  Drag & drop images here
                </p>
                <p className="text-[11px] uppercase tracking-wider text-text-muted mt-2">
                  or click to browse (max {MAX_IMAGES} images)
                </p>
              </div>
            ) : (
              <div className="p-4 border-none bg-dasadeep/10 text-center">
            ...
            {errors.images && (
              <p className="text-red-600 text-[10px] uppercase tracking-wider font-bold mt-2">
                {errors.images}
              </p>
            )}
            ...
            {mergedImages.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                {mergedImages.map((img, idx) => (
                  <div
                    key={idx}
                    className="relative group aspect-[4/5] border-none bg-dasadeep"
                  >
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 w-8 h-8 bg-white border-none flex items-center justify-center text-text-muted hover:text-red-600 opacity-0 group-hover:opacity-100 transition-all shadow-sm"
                    >
                      <X className="w-4 h-4" strokeWidth={1.5} />
                    </button>
                    {img.type === "new" && (
                      <div className="absolute bottom-2 left-2 bg-white/90 px-2 py-0.5 text-[9px] uppercase tracking-widest font-bold border-none ">
                        New
                      </div>
                    )}
                  </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white border-none p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                />
                <p className="text-[10px] text-text-muted mt-2 tracking-wider font-medium">
                  Determines the "In Stock" or "Out of Stock" status.
                </p>
                {errors.stock && (
                  <p className="text-red-600 text-[10px] uppercase tracking-wider font-bold mt-1.5">
                    {errors.stock}
              ...
              <div className="pt-6 ">
                ...
                <p className="text-[10px] text-text-muted mb-4 tracking-wider font-medium">
                  Add options like Size (e.g. 50ml, 100ml) or Color.
                </p>
                ...
                <div className="flex flex-col gap-3 mb-5">
                  <Input
                    ...
                    className="bg-dasadeep/20 text-[12px] rounded-2xl focus-visible:ring-0 focus-visible: text-[#222222] h-10 w-full"
                  />
                  <Input
                  ...
                  <button
                    ...
                    className="bg-dasadeep/50 text-[#222222] border-none w-full py-2.5 text-[11px] uppercase tracking-wider font-bold hover:bg-dasadeep transition-colors"
                  >
                    Add Variant
                  </button>
                </div>
                ...
                {product.variants.length > 0 ? (
                  <div className="space-y-2">
                    {product.variants.map((v, i) => (
                      <div
                        key={i}
                        className="bg-dasadeep/10 border-none p-3 flex justify-between items-start gap-4"
                      >
                  ...
                  <div className="bg-dasadeep/10 p-3 border-none text-[11px] text-text-muted italic">
                    No variants added.
                  </div>
                )}
              </div>
          ...
          <div className="bg-white border-none p-6 md:p-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4 p-4 border-none bg-dasadeep/10">
                <Checkbox
                  id="isFeatured"
                  ...
                  className="rounded-2xl data-[state=checked]:bg-primary data-[state=checked]: mt-0.5 w-5 h-5 bg-white"
                />
                <div className="grid gap-2 leading-none">
                  ...
                  <p className="text-[11px] text-text-muted leading-relaxed">
                    Select to highlight this product on the storefront homepage
                    cards.
                  </p>
                </div>
              </div>
