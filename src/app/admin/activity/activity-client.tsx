    ...
    <div className="flex-1 space-y-8 pb-10 max-w-7xl mx-auto">
      ...
      <div className="bg-white border-none overflow-hidden">
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow className="bg-dasadeep/20 hover:bg-dasadeep/20">
                <TableHead className="text-[10px] uppercase tracking-wider font-bold text-text-muted h-12 w-48">
                  Timestamp
                </TableHead>
                <TableHead className="text-[10px] uppercase tracking-wider font-bold text-text-muted h-12 w-48">
                  User
                ...
                <TableHead className="text-[10px] uppercase tracking-wider font-bold text-text-muted h-12">
                  Details
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {logs.length === 0 ? (
                <TableRow>
                  <TableCell
                    colSpan={4}
                    className="h-32 text-center text-[12px] text-text-muted"
                  >
                ...
                logs.map((log) => (
                  ...
                  >
                    ...
                    <TableCell>
                      <span className="inline-flex items-center px-2 py-0.5 rounded-2xl text-[9px] uppercase tracking-widest font-bold bg-dasadeep/50 text-[#222222] border-none ">
