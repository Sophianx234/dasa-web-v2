...
export default function AdminSettingsPage() {
  ...
  const handleEmailUpdate = async () => {
    const validate = emailSchema.safeParse({
          ...
          <div className="bg-white border-none p-6 md:p-8 space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-6">
                <div className="relative w-20 h-20 bg-dasadeep/30 border-none shrink-0 group">
                  {profile.image ? (
                    <>
                      <img
                        src={profile.image}
                      ...
                      <button
                        onClick={clearImage}
                        className="absolute top-1 right-1 w-5 h-5 bg-white border-none flex items-center justify-center text-red-600 opacity-0 group-hover:opacity-100 transition-opacity"
                      >
                ...
                <div>
                  <div className="relative inline-block">
                    ...
                    />
                    <button className="bg-dasadeep/50 border-none text-[#222222] px-4 py-2 text-[10px] uppercase tracking-wider font-bold hover:bg-dasadeep transition-colors flex items-center gap-2">
                      <Upload className="w-3.5 h-3.5" /> Upload Photo
                    </button>
                  </div>
                  <p className="text-[10px] text-text-muted mt-2 tracking-wider">
              ...
              <div>
                ...
                />
                {errors.profileName && (
                  <p className="text-red-600 text-[11px] mt-1 uppercase tracking-wider">
                    {errors.profileName}
                  </p>
                )}
              </div>
