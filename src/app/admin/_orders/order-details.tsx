...
export default function OrderDetailsSheetContent({
  ...
  return (
    <div className="flex flex-col h-full bg-[#fdfbf7]">
      ...
      <div className="px-8 py-8 bg-white relative">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex justify-between items-start pt-6">
            <div>
              <h2 className="text-[20px] uppercase tracking-widest font-bold text-[#222222]">
                Order Details
              </h2>
          ...
          <div className="flex items-center gap-4">
            ...
            {user?.role === "admin" || user?.role === "manager" ? (
              <Select
                ...
                onValueChange={(v) => onStatusChange(order.paymentReference, v)}
              >
                <SelectTrigger className="h-9 w-56 text-[11px] uppercase tracking-wider font-bold rounded-2xl focus:ring-0 bg-white shadow-none">
                  <SelectValue>
                ...
                <SelectContent className="rounded-2xl shadow-sm">
                  {Object.entries(STATUS_CONFIG).map(([k, c]) => (
                    <SelectItem
                      key={k}
                      value={k}
                      className="text-[11px] uppercase tracking-wider cursor-pointer rounded-2xl focus:bg-dasadeep/50"
                    >
                      {c.label}
                    </SelectItem>
                  ))}
              ...
              <div className="h-9 w-56 px-3 flex items-center text-[11px] uppercase tracking-wider font-bold border-none bg-white">
        ...
        >
          ...
          <section>
            ...
            <div className="border-none bg-white">
              <div className="divide-y divide-">
                {items.map((it, idx) => (
                  <div key={idx} className="p-4 flex gap-4 items-center">
                    <div className="w-16 h-16 border-none bg-dasadeep/20 flex-shrink-0">
                      {it.image ? (
                        <img
                          src={it.image}
                          alt={it.name}
                    ...
                    <div className="flex-1 flex items-center justify-between">
                      ...
                      <div className="text-[13px] font-bold text-[#222222]">
              ...
              <div className="p-4 bg-dasadeep/10 flex justify-between items-center">
              ...
              <div className="border-none bg-white p-5 space-y-4">
                <div className="flex items-center gap-3">
                  <img
                    src={
                      order.user?.profile ||
                      `https://ui-avatars.com/api/?name=${encodeURIComponent(order.user?.name || "Guest")}`
                    }
                    alt={order.user?.name || "Guest"}
                    className="w-10 h-10 object-cover border-none "
                  />
                  <div>
                    <div className="text-[13px] font-bold text-[#222222]">
                ...
                {order.user?.email && (
                  <div className="pt-4 ">
                    ...
                    <div className="text-[12px] text-[#222222] mt-1">
                      {order.user.email}
                    </div>
                  </div>
                )}
            ...
            <section>
              ...
              <div className="border-none bg-white p-5 space-y-4">
                <div>
                  ...
                  <div className="text-[12px] text-[#222222] mt-1 font-medium">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-2">
                ...
                <div className="flex items-center gap-3 bg-dasadeep/10 px-3 py-1.5 border-none ">
                  ...
                  <Switch
                    ...
                    onCheckedChange={setIsMapInteractive}
                  />
                </div>
              </div>
              <OrderMap
      ...
      {/* FOOTER ACTIONS */}
      <div className="px-8 py-4 bg-white flex flex-wrap items-center justify-between gap-4 mt-auto">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="border-none bg-white text-[#222222] px-4 py-2.5 text-[10px] uppercase tracking-wider font-bold hover:bg-dasadeep/50 transition-colors flex items-center justify-center gap-2"
          >
          ...
          {user?.role === "admin" && (
            <button
              ...
              className="h-10 px-6 flex items-center gap-2 border-none text-red-600 font-bold text-[11px] uppercase tracking-widest hover:bg-red-50 transition-colors"
            >
              Delete Order
            </button>
          )}
