                  ...
                  >
                    <TableCell>
                      <div className="flex items-start gap-3">
                        <div className="relative h-12 w-12 min-w-[48px] rounded-lg overflow-hidden border-none bg-gray-100">
                          <Image
                        ...
                        <div className="flex flex-col gap-1">
                          <span
                            className="font-semibold text-sm leading-none truncate max-w-[200px]"
                            title={p.name}
                          >
                            {p.name}
                          </span>
