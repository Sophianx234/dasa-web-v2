...
function Sidebar({
 ...
 className="bg-sidebar group-data-[variant=floating]: flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border-none group-data-[variant=floating]:shadow-sm"
 >
 {children}
 </div>
 </div>
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
 ...
 className={cn(
 "hover:after:bg-sidebar-border-none absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] sm:flex",
...
function SidebarSeparator({
 ...
 className={cn("bg-sidebar-border-none mx-2 w-auto", className)}
 {...props}
 />
 );
}
...
const sidebarMenuButtonVariants = cva(
 ...
 outline:
 "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border-none))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]",
 },
 size: {
 default: "h-8 text-sm",
 sm: "h-7 text-xs",
