...
export default function Sidebar() {
  ...
  return (
    <aside
      className={`h-screen hidden md:flex sticky top-0 flex-col bg-white transition-all duration-300 ${
    ...
    >
          ...
          return (
            <button
              ...
              className={`relative flex items-center gap-4 w-full px-4 py-3.5 transition-all outline-none focus:outline-none group ${
                isActive
                  ? "bg-dasadeep/70 text-[#222222]"
                  : "text-text-muted hover:text-[#222222] hover:bg-dasadeep/40"
              } ${collapsed ? "justify-center px-0" : ""}`}
            >
              <Icon
                size={18}
                strokeWidth={1.5}
                className={`flex-shrink-0 transition-colors ${isActive ? "" : "text-text-muted group-hover:text-[#222222]"}`}
              />
      ...
      <div className=" p-4 mt-auto space-y-1">
        <button
          ...
          className={`flex items-center gap-4 w-full px-4 py-3.5 text-text-muted hover:text-[#222222] hover:bg-dasadeep/40 transition-colors outline-none focus:outline-none group ${collapsed ? "justify-center px-0" : ""}`}
        >
          <Settings
            size={18}
            strokeWidth={1.5}
